               ...
               <div className="space-y-4 mb-8 text-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div>
                       ...
                       <input required type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} className="w-full bg-cream/50 border border-border/50 rounded-lg px-4 py-3 focus:outline-none focus:border-primary transition-colors" placeholder="+91 90000 00000" />
                     </div>
                  </div>
               </div>
