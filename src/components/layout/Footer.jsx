          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <a href={siteConfig.social.facebook} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-lg bg-primary text-white flex items-center justify-center hover:bg-primary-dark transition-all shadow-sm">
                  <Facebook size={18} />
                </a>
                <a href={`https://wa.me/${siteConfig.contact.phone?.replace(/\D/g, '')}`} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-lg bg-primary text-white flex items-center justify-center hover:bg-primary-dark transition-all shadow-sm">
